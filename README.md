<p align="center">
    ...
    <a href="https://travis-ci.org/KituraKommunity/BlueSSLService">
    <img src="https://travis-ci.org/KituraKommunity/BlueSSLService.svg?branch=master" alt="Build Status - Master">
    </a>
...
SSL/TLS Add-in framework for [BlueSocket](https://github.com/KituraKommunity/BlueSocket.git) in Swift using the Swift Package Manager. Works on supported Apple platforms (using Secure Transport) and on Linux (using OpenSSL).
...
This library is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/KituraKommunity/BlueSSLService/blob/master/LICENSE).
