...
var packageDependencies: [Package.Dependency] = [.package(url: "https://github.com/KituraKommunity/BlueSocket.git", from: "1.0.0")]
var targetDependencies: [Target.Dependency] = [.byNameItem(name: "Socket")]

#if os(Linux)
	
packageDependencies.append(.package(url: "https://github.com/KituraKommunity/OpenSSL.git", from: "1.0.0"))
